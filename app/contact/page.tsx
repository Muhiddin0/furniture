      ...
      <div className="container my-24 mx-auto md:px-6 *:!text-black">
        ...
        <section className="mb-32">
          ...
          <div className="container px-6 md:px-12">
            <div className="block rounded-lg bg-[hsla(0,0%,100%,0.8)] px-6 py-12 shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] dark:bg-[hsla(0,0%,15%,0)] dark:shadow-black/20 md:py-16 md:px-12 -mt-[100px] backdrop-blur-[30px]">
                  ...
                  <form className="flex flex-col gap-6">
                    <div className="flex gap-3 ">
                      <label className="flex flex-col gap-2" htmlFor="">
                        ...
                        <input
                          className="px-2 py-1 bg-transparent border-b-[1px] border-b-slate-400 outline-none"
                          placeholder="Name"
                          type="text"
                        />
                      </label>
                    ...
                    <textarea
                      className="border-[1px] border-slate-400 rounded-md p-3"
                      placeholder="Your message"
                    ></textarea>

                    <button className="flex justify-center items-center bg-orange-500 p-3 text-white rounded-md shadow-md hover:opacity-80 shadow-orange-500">
                      Send Message
                    </button>
                  </form>
                </div>
